    ...
    <Transition name="fade-transform" mode="out-in">
      <div class="page" v-if="friend.length">
        ...
        <div class="me">
          ...
          <span>★ Bio：時の雨</span>
          <span>★ Motto：下沉的世界，溯流而上</span>
          <span>★ URL：https://blog.stock9host.com</span>
          <span
            >★ Avatar：<a href="https://cdn.jsdelivr.net/gh/GhostAdults/blog-cdn/icon/avatar.jpg" target="_blank"
              >点击获取</a
            ></span
          >
